const quizData = [
  {
    question: "Who popularised the phrase 'break the ice' in English literature?",
    options: [
      "William Shakespeare",
      "Jane Austen",
      "Charles Dickens",
  ...
  {
    question: "What is the purpose of an icebreaker activity?",
    options: [
      "To provide detailed training content",
      "To encourage people to relax and get to know each other",
      "To measure productivity",
      "To enforce strict schedules"
    ],
    answerIndex: 1
  },
  {
    question: "Which of these is a common style of icebreaker question?",
    options: [
      "Asking participants to recite a poem",
      "Discussing quarterly revenue reports",
      "Sharing a surprising personal fact",
      "Debating technical specifications"
    ],
    answerIndex: 2
  },
  {
    question: "How long should a quick team icebreaker usually take?",
    options: ["1-5 minutes", "20-30 minutes", "45-60 minutes", "More than an hour"],
    answerIndex: 0
  },
  {
    question: "What makes an effective quiz icebreaker for remote teams?",
    options: [
      "One that relies heavily on physical props",
      "One that encourages everyone to participate via chat or video",
      "One that excludes new team members",
      "One that focuses on complex policies"
    ],
    answerIndex: 1
  }
];

const leaderboardKey = "breakerQuizLeaderboard";
